        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Perbarui transaksi peminjaman barang.</p>

                    <form action="{{ route('peminjaman.update', $peminjaman) }}" method="post" novalidate>
                        @csrf
                        @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="mahasiswa_id"
                                        ...
                                        @foreach ($mahasiswa as $item)
                                            <option value="{{ $item->id }}" @selected(old('mahasiswa_id', $peminjaman->mahasiswa_id) == $item->id)>
                                                {{ $item->nim }} - {{ $item->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="barang_id" class="form-select @error('barang_id') is-invalid @enderror">
                                        ...
                                        @foreach ($barangs as $barang)
                                            <option value="{{ $barang->id }}" @selected(old('barang_id', $peminjaman->barang_id) == $barang->id)>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="waktu_pinjam"
                                        ...
                                        value="{{ old('waktu_pinjam', $peminjaman->waktu_pinjam?->format('Y-m-d\TH:i')) }}">
                                    @error('waktu_pinjam')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="waktu_kembali"
                                        ...
                                        value="{{ old('waktu_kembali', $peminjaman->waktu_kembali?->format('Y-m-d\TH:i')) }}">
                                    @error('waktu_kembali')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="jumlah_pinjam"
                                        ...
                                        value="{{ old('jumlah_pinjam', $peminjaman->jumlah_pinjam) }}" min="1">
                                    @error('jumlah_pinjam')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="jumlah_kembali"
                                        ...
                                        value="{{ old('jumlah_kembali', $peminjaman->jumlah_kembali) }}" min="0">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="3"
                                placeholder="Opsional...">{{ old('keterangan', $peminjaman->keterangan) }}</textarea>
                            @error('keterangan')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
