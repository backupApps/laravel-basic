                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="javascript: void(0);">Appzia</a>
                        </li>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h2 class="mt-3 mb-2">
                        <i class="mdi mdi-arrow-down text-danger me-2"></i><b>8952</b>
                    </h2>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-body p-t-10">
                    ...
                    <h2 class="mt-3 mb-2">
                        <i class="mdi mdi-arrow-up text-success me-2"></i><b>6521</b>
                    </h2>
                    <p class="text-muted mb-0 mt-3">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-body p-t-10">
                    ...
                    <h2 class="mt-3 mb-2">
                        <i class="mdi mdi-arrow-up text-success me-2"></i><b>452</b>
                    </h2>
                    <p class="text-muted mb-0 mt-3">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-center">
                <div class="card-body p-t-10">
                    ...
                    <h2 class="mt-3 mb-2">
                        <i class="mdi mdi-arrow-down text-danger me-2"></i><b>5621</b>
                    </h2>
                    <p class="text-muted mb-0 mt-3">
        ...
        <div class="col-lg-5">
            <div class="card card-h-100">
                <div class="card-body">
                    ...
                    <p class="font-600 mb-1">
                        Add Product to cart
                        <span class="text-primary float-end"><b>80%</b></span>
                    </p>
                    ...
                    <p class="font-600 mb-1">
                        Complete Purchases
                        <span class="text-primary float-end"><b>50%</b></span>
                    </p>
                    <div class="progress mb-3">
                        <div
                            class="progress-bar progress-bar-primary"
                    ...
                    <p class="font-600 mb-1">
                        Visit Premium plan
                        <span class="text-primary float-end"><b>70%</b></span>
                    </p>
                    <div class="progress mb-3">
                        <div
                            class="progress-bar progress-bar-primary"
                    ...
                    <p class="font-600 mb-1">
                        Send Inquiries
                        <span class="text-primary float-end"><b>65%</b></span>
                    </p>
                    <div class="progress mb-3">
                        <div
                            class="progress-bar progress-bar-primary"
                    ...
                    <p class="font-600 mb-1">
                        Monthly Purchases
                        <span class="text-primary float-end"><b>25%</b></span>
                    </p>
                    <div class="progress mb-3">
                        <div
                            class="progress-bar progress-bar-primary"
                    ...
                    <p class="font-600 mb-1">
                        Daily Visits<span class="text-primary float-end"><b>40%</b></span>
                    </p>
